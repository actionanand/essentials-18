...
```bash
git clone https://github.com/actionanand/essentials-18.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/essentials-18#1-skeleton angular-proj-name
```
